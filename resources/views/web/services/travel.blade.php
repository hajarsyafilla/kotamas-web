    ...
    <section class="row header-breadcrumb">
        ...
        <div class="container">
            <div class="row m0 page-cover">
                <h2 class="page-cover-tittle">Kotamas Travel</h2>
                <ol class="breadcrumb">
                    <li><a href="{{ url('/') }}">Utama</a></li>
                    <li>Perkhidmatan</li>
                    <li class="active">Kotamas Travel</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="services-img">
                        <img class="img-responsive" alt="" src="{{ asset('assets/biznext/image/umrahh.jpg') }}">
                    </div>
                </div>
  ...
  >
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="services-img">
                        <img class="img-responsive" alt="" src="{{ asset('assets/biznext/image/korea.PNG') }}">
                    </div>
                </div>
                <div class="col-md-8 col-sm-12 s-content">
                    <h2>Pakej Korea</h2>
...
<br>
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="services-img">
                        <img class="img-responsive" alt="" src="{{ asset('assets/biznext/image/turki.JPG') }}">
                    </div>
                </div>
                <div class="col-md-8 col-sm-12 s-content">
                    <h2>Pakej Turki</h2>
